...
<a href="ORDER.jsp"><img src="ADMINLOGIN/images/arrow.png"></a>
<h1>View All Reports</h1>



<display:table id="DisplayUOrder"  name="ordlist"  pagesize="10"  export="true" requestURI="" keepStatus="true"   style="width : 100%;" class=" table table-dark table-striped table-condensed    table-hover">
	<display:column style="width: 10%" title="&nbsp;SNo"  >						
	${DisplayOrder_rowNum}		 	 	
	</display:column>
	
	<display:column property="orderid" title="Order Id" style="width : 5%" />	
	<display:column property="usid" title="User Id" style="width : 5%" />
    <display:column property="orddate" title="Date" style="width : 15%" />
    <display:column property="ordamt" title="Amount" style="width : 20%" />
    <display:column property="orddeladdress" title="Delivery" style="width : 15%" />
    <display:column property="ordstatus" title="Status" style="width : 20%" />
