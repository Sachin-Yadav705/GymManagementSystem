...
<a href="PAYMENT.jsp"><img src="ADMINLOGIN/images/arrow.png"></a>
<h1>View All Reports</h1>



<display:table id="Displaypayment"  name="pylst"  pagesize="10"  export="true" requestURI="" keepStatus="true"   style="width : 100%;" class=" table table-dark table-striped table-condensed    table-hover">
	<display:column style="width: 10%" title="&nbsp;SNo"  >						
	${Displaypayment_rowNum}		 	 	
	</display:column>
	
	<display:column property="payid" title="PAY Id" style="width : 5%" />
    <display:column property="usid" title="USRE ID" style="width : 15%" />
    <display:column property="orderid" title="ORDER ID" style="width : 20%" />
    <display:column property="payamt" title="AMOUNT" style="width : 15%" />
    <display:column property="paydate" title="DATE" style="width : 20%" />
    <display:column property="paymode" title="MODE" style="width : 10%" />
