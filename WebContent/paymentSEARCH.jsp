...
<fieldset>
 <legend align="center"><h1>Search PAYMENT</h1></legend><br><br>
<s:form action="SearchPAYmentId" method="post" style="padding-left: 50px;">
...
<fieldset>
 <legend align="center"><h1>PAYMENT Details</h1></legend><br><br>
