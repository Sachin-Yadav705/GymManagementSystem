...
<a href="USER.jsp"><img src="ADMINLOGIN/images/arrow.png"></a>
<h1>View All Reports</h1>



<display:table id="DisplayUser"  name="urlist"  pagesize="10"  export="true" requestURI="" keepStatus="true"   style="width : 100%;" class=" table table-dark table-striped table-condensed    table-hover">
	<display:column style="width: 10%" title="&nbsp;SNo"  >						
	${DisplayUser_rowNum}		 	 	
	</display:column>
	
	<display:column property="userid" title="User Id" style="width : 5%" />
    ...
    <display:column property="password" title="Password" style="width : 10%" />
